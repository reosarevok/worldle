...
// Source: https://www.eki.ee/knab/maadiso.htm + Wikipedia for missing ones
const estonianCountryNames: Record<string, string> = {
  AD: "Andorra",
  ...
  FR: "Prantsusmaa",
  GA: "Gabon",
  GB: "Suurbritannia (Ühendkuningriik)",
  GD: "Grenada",
  GE: "Gruusia",
  ...
  IM: "Mani saar",
  IN: "India",
  IO: "Briti India ookeani ala (Diego Garcia)",
  IQ: "Iraak",
  IR: "Iraan",
  IS: "Island",
  IT: "Itaalia",
...
export function getCountryName(language: string, country: Country) {
  if (language === "et") {
    return estonianCountryNames[country.code];
  }
  if (language === "fr") {
